...
import UserAccount       from './UA_UserAccount'
import UserProfile       from './UA_UserProfile'
import FundraisingActivity from './FR_ManageFRA'
import BrowseCampaigns   from './Donee_BrowseFRA'
import ViewCampaigns     from './FR_BrowseFRA'
import FRACategory       from './PM_FRACategory'
import Favourites        from './Donee_Favourites'
import DonationHistory   from './Donee_DonationHistory'
import Reports           from './PM_Reports'
