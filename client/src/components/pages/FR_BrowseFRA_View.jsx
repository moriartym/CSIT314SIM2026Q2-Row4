...
export default function FR_BrowseFRA_View({ fraId, onBack }) {
  ...
  return (
    <div className="ua-card">
      ...
      <div style={{ marginBottom: '0.75rem' }}>
        <p className="ua-muted" style={{ fontSize: '0.72rem' }}>ID: {fra._id}</p>
      ...
      <ReadField label="Created By"    value={fra.createdBy?.username} />
