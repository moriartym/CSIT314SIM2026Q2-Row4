...
import ListFavouriteController from '../controllers/favourite/listFavouriteController.js'
import RemoveFavouriteController from '../controllers/favourite/removeFavouriteController.js'
import { requireAuth, requirePermission } from '../middleware/authMiddleware.js'

const router = express.Router()
router.get('/', requireAuth, requirePermission('donating'), (req, res) => ListFavouriteController.listFavourite(req, res))
