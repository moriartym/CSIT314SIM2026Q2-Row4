...
import ViewFRAShortlistCountController from '../controllers/fra/viewFRAShortlistCountController.js'
...
router.get('/all', requireAuth, requirePermission('donating'), (req, res) => ViewAllActiveFRAController.viewAllActiveFRA(req, res))
router.get('/all/search', requireAuth, requirePermission('donating'), (req, res) => SearchFRAHistoryController.searchFRAHistory(req, res))
router.patch('/:id/complete', requireAuth, requirePermission('fundraising'), (req, res) => CompleteFRAController.completeFRA(req, res))
router.post('/:id/view', requireAuth, requirePermission('donating'), (req, res) => ViewFRAViewCountController.viewFRAViewCount(req, res))
router.get('/:id', requireAuth, requirePermission('fundraising'), (req, res) => ViewFRAController.viewFRA(req, res))
...
router.post('/:id/shortlist', requireAuth, requirePermission('donating'), (req, res) => ViewFRAShortlistCountController.viewFRAShortlistCount(req, res))
