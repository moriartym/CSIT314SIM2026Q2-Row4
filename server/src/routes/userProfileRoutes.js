...
import ListAllProfilesController from '../controllers/userProfile/listAllProfilesController.js'
...
router.get('/all', requireAuth, requirePermission('user_management'), (req, res) => ListAllProfilesController.listAll(req, res))
